...
const BlogForm = () => {
  ...
  const handleClose = () => {
    setIsVisible(false); // Set visibility to false when cancel or cross is clicked
  };
      ...
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-8 relative">
        <div className="flex items-center">
          ...
          <svg
            ...
            onClick={handleClose} // Close form on cross icon click
          >
        ...
        <form className="space-y-4 mt-8" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-4 mt-8">
            <button
              ...
              onClick={handleClose} // Close form on cancel button click
            >
              Cancel
            </button>
            <button
